...
namespace Minesweeper.Runtime.Gameplay
{
    public class GridData
    {
        ...
        public GridData(int width, int height, int minesCount)
        {
            Width = width;
            Height = height;
            MinesCount = minesCount;
            CellsRemaining = width * height - minesCount;
        ...
        public void DecreaseCellsRemaining(int amount) =>
            CellsRemaining -= amount;
