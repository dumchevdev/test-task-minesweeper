...
namespace Minesweeper.Tests.EditMode
{
    public class SessionTests
    {
        ...
        public void SetUp()
        {
            ...
            _session = new SessionState(grid, new Random());
        }
        ...
        public void Playing_OpenCell_Mine_TransitionsToLost()
        {
            ...
            _session.OpenCell(cellData);
            Assert.AreEqual(SessionStateType.Finished_Lost, _session.StateType);
        }
        ...
        public void Playing_OpenCell_AllNonMines_TransitionsToWon()
        {
            ...
            Assert.AreEqual(SessionStateType.Finished_Won, _session.StateType);
        }
    }
}